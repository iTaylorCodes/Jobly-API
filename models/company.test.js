...
describe("findAll", function () {
  ...
  test("works: search filter = name", async () => {
  ...
  test("works: search filter = minEmployees", async () => {
  ...
  test("works: search filter = maxEmployees", async () => {
  ...
  test("works: search filter = minEmployees & maxEmployees", async () => {
  ...
  test("bad request: minEmployees greater than maxEmployees", async () => {
    try {
